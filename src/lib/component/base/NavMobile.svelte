    ...
    <div class="flex gap-12">
        <div class="flex items-center gap-4">
            ...
            {#if $page.url.pathname === '/app/chat'}
                <button on:click={resetChat} class="h-10 w-10 flex justify-center items-center gap-[10px] rounded-lg bg-primary-200/50 dark:bg-[#212121] text-primary-800 dark:text-white/80 hover:text-indigo-500 dark:hover:text-indigo-500 duration-200 select-none" >
        ...
        <div class="flex items-center gap-4">
            ...
            <a href="mailto:tylergstock@gmail.com" class="h-10 w-10 flex justify-center items-center duration-200 rounded-lg bg-primary-200/50 dark:bg-[#212121] text-primary-800 dark:text-white/80 hover:text-indigo-500 dark:hover:text-indigo-500">
                <i class="material-symbols-rounded text-[24px]">email</i>
            </a>
            <a href="https://www.linkedin.com/in/tyler-stock/" target="_blank" class="h-10 w-10 flex justify-center items-center duration-200 rounded-lg group bg-primary-200/50 dark:bg-[#212121] fill-primary-800 dark:fill-white/80 hover:fill-indigo-500 dark:hover:fill-indigo-500">
